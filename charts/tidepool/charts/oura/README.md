...
| configmap.jotformBaseURL | string | `""` | jotform base URL |
| configmap.jotformFormId | string | `""` | jotform OURA eligibility form ID |
...
| configmap.shopifyStoreId | string | `""` | shopify store ID |
...
| secret.data_.jotformAPIKey | string | `""` | jotform API Key |
| secret.data_.partnerSecret | string | `""` | plaintext partner secret |
| secret.data_.shopifyClientId | string | `""` | plaintext Shopify Client ID |
| secret.data_.shopifyClientSecret | string | `""` | plaintext Shopify Client Secret |
